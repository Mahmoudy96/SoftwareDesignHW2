...
interface File {
    ...
    fun getPiece(infohash:String, filename: String, pieceIndex: Int): CompletableFuture<ByteArray>
    fun updatePiece(infohash: String, filename: String, pieceIndex: Int, piece: ByteArray): CompletableFuture<Unit>
